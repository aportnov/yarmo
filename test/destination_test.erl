...
create_queue_test() ->
	Store = mock_store:new({{read, unused}, {create, {{id, "id"}, {rev, "Rev"}}}, {create, unused} }),
...
find_destination_not_existing_test() ->
	Store = mock_store:new({{read, not_found}, {create, unused}, {create, unused} }),
...
find_destination_test() ->
	...
	Store = mock_store:new({{read, Document}, {create, unused}, {create, unused}}), 	
